...
class Factory:
    ...
    @staticmethod
    def cast_to_dictionary(obj: object) -> dict:
        """
    ...
    def user(dictionary: dict) -> user.User:
        a_user = user.User()
        dictionary = Factory.cast_to_dictionary(dictionary)
    ...
    def tweet(dictionary: dict) -> tweet.Tweet:
        ...
        if "coordinates" in dictionary:
            a_tweet.coordinates = dictionary["coordinates"]
        if "created_at" in dictionary:
    ...
    def entities(dictionary: dict) -> entities.Entities:
        ...
        if "hashtags" in dictionary:
            for hashs in dictionary["hashtags"]:
                a_entities.hashtags.append(hashs["text"])
    ...
    @staticmethod
    def place_attributes(dictionary: dict) -> place.PlaceAttributes:
        a_place_attributes = place.PlaceAttributes()
        dictionary = Factory.cast_to_dictionary(dictionary)
    ...
    @staticmethod
    def bounding_box(dictionary: dict) -> place.BoundingBox:
        a_bounding_box = place.BoundingBox()
        dictionary = Factory.cast_to_dictionary(dictionary)
        if "coordinates" in dictionary:
