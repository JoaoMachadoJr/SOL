    ...
    def __init__(self, token="", dictionary=dict()):
        ...
        if ("admin_notes") in dict_user:
            for i in dict_user["admin_notes"]:
                self.admin_notes.append(Admin_Note(dictionary=i))
        ...
        if ("hometown") in dict_user:
            self.hometown = Page(dict_user["hometown"])
        if ("inspirational_people") in dict_user:
            for i in dict_user["inspirational_people"]:
                self.inspirational_people.append(Experience(dictionary=i))
        ...
        if ("labels") in dict_user:
            for i in dict_user["labels"]:
                self.labels.append(Page_Label(dictionary=i))
        if ("languages") in dict_user:
            for i in dict_user["languages"]:
                self.languages.append(Experience(dictionary=i))
        ...
        if ("location") in dict_user:
            self.location = Page(dict_user["location"])
        ...
        if ("significant_other") in dict_user:
            self.significant_other = User(dict_user["significant_other"])
        if ("sports") in dict_user:
            for i in dict_user["sports"]:
                self.sports.append(Experience(dictionary=i))
        ...
        if ("work") in dict_user:
            for i in dict_user["work"]:
                self.work.append(Experience(dictionary=i))
